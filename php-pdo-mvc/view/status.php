...
if($created) echo "New city record successfully created.";
if($updated) echo "New city record successfully updated.";
if($deleted) echo "New city record successfully deleted.";
?>